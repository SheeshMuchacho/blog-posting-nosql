      ...
      <div className="max-container flexBetween padding-container">
            ...
            {NAV_LINKS.map((link) => (
              ...
              >
                {link.dropdown ? (
                  <div>
                    <button
                      className="text-text-dark text-sm font-sans font-medium hover:text-secondary transition-all flex items-center"
                  ...
                  <Link
                    href={link.href}
                    className="text-text-dark text-sm font-sans font-medium hover:text-secondary transition-all"
                  >
                    {link.label}
                  </Link>
                )}
        ...
        <div className="hidden lg:block">
          <Button
            type="button"
            title="Contact Us"
            className="btn_outline_secondary"
          />
        </div>
        ...
        {/* Mobile Menu */}
        <div 
          className={`fixed top-0 right-0 h-full w-4/5 max-w-sm bg-white z-40 shadow-xl p-6 overflow-y-auto transition-transform duration-300 ease-in-out transform lg:hidden ${
        ...
        >
            ...
            {NAV_LINKS.map((link, index) => (
              ...
              >
                {link.dropdown ? (
                  <div>
                    <button
                      className="text-text-dark text-base font-sans font-medium hover:text-secondary transition-all flex items-center justify-between w-full"
                  ...
                  <Link
                    href={link.href}
                    className="text-text-dark text-base font-sans font-medium hover:text-secondary transition-all flex items-center"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    {link.label}
                  </Link>
          ...
          >
            <Button
              type="button"
              title="Contact Us"
              className="btn_outline_secondary w-full"
            />
          </div>
        </div>
      </div>
